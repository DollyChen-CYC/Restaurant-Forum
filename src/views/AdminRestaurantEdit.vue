<template>
  <div class="container py-5">
    <AdminRestaurantForm @after-form-submit="handleAfterFormSubmit" :initial-restaurant="restaurant" />
  </div>
</template>
...
export default {
  ...
  methods: {
    fetchRestaurant(restaurantId) {
      console.log(`fetching data of restaurant id-${restaurantId} from API.`);
      const {
        id,
        name,
